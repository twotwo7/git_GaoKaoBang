...
/*class zizhu extends StatelessWidget {
  final title;
  final url;
  zizhu({Key key, @required this.url,this.title}) : super(key: key);
  @override
          ...
          new MaterialApp(
            routes: {
              "/": (_) => new WebviewScaffold(
                url: this.url,//this.url,//hd.xinli001.cc/cp-m/index.html#/ceshi/838/answer?channelId=513&userAwaitTestScaleId=0",
                appBar: new AppBar(
...
class zizhu extends StatefulWidget{
  String  news_url;
  String title;
  zizhu(this.news_url,this.title);
  @override
  State<StatefulWidget> createState()=>new zizhuState(news_url,title);
}
class zizhuState extends State<zizhu>{
  String  news_url;
  String title;
  // 标记是否是加载中
  bool loading = true;
  ...
  zizhuState(this.news_url, this.title);
